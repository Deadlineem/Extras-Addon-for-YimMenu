...
Stats:add_button("Unlock All", function() --Original script by ShinyWasabi
    script.run_in_fiber(function (script)
        ...
        locals.set_int('MPPLY_CREW_NO_HEISTS_0', 2)
        locals.set_int('MPPLY_CREW_NO_HEISTS_1', 5)
        locals.set_int('MPPLY_CREW_NO_HEISTS_2', 5)
        locals.set_int('MPPLY_CREW_NO_HEISTS_3', 5)
        locals.set_int('MPPLY_CREW_NO_HEISTS_4', 5)
        locals.set_int('MPPLY_GANGOPS_LOYALTY2', -1)
        locals.set_int('MPPLY_GANGOPS_LOYALTY3', -1)
        locals.set_int('MPPLY_GANGOPS_CRIMMASMD2', -1)
        locals.set_int('MPPLY_GANGOPS_CRIMMASMD3', -1)
        locals.set_int('MPPLY_GANGOPS_SUPPORT', -1)
        locals.set_int('MPPLY_GANGOPS_ALLINORDER', -1)
        locals.set_int('MPPLY_GANGOPS_LOYALTY', -1)
        locals.set_int('MPPLY_GANGOPS_CRIMMASMD', -1)
        locals.set_int('MPPLY_XMASLIVERIES0', -1)
        locals.set_int('MPPLY_XMASLIVERIES1', -1)
        locals.set_int('MPPLY_XMASLIVERIES2', -1)
        locals.set_int('MPPLY_XMASLIVERIES3', -1)
        locals.set_int('MPPLY_XMASLIVERIES4', -1)
        locals.set_int('MPPLY_XMASLIVERIES5', -1)
        locals.set_int('MPPLY_XMASLIVERIES6', -1)
        locals.set_int('MPPLY_XMASLIVERIES7', -1)
        locals.set_int('MPPLY_XMASLIVERIES8', -1)
        locals.set_int('MPPLY_XMASLIVERIES9', -1)
        locals.set_int('MPPLY_XMASLIVERIES10', -1)
        locals.set_int('MPPLY_XMASLIVERIES11', -1)
        locals.set_int('MPPLY_XMASLIVERIES12', -1)
        locals.set_int('MPPLY_XMASLIVERIES13', -1)
        locals.set_int('MPPLY_XMASLIVERIES14', -1)
        locals.set_int('MPPLY_XMASLIVERIES15', -1)
        locals.set_int('MPPLY_XMASLIVERIES16', -1)
        locals.set_int('MPPLY_XMASLIVERIES17', -1)
        locals.set_int('MPPLY_XMASLIVERIES18', -1)
        locals.set_int('MPPLY_XMASLIVERIES19', -1)
        locals.set_int('MPPLY_XMASLIVERIES20', -1)
        locals.set_int('MPX_HOLDUPS_BITSET', -1)
        locals.set_int('MPX_CHAR_ABILITY_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_ABILITY_2_UNLCK', -1)
        locals.set_int('MPX_CHAR_ABILITY_3_UNLCK', -1)
        locals.set_int('MPX_CHAR_WEAP_UNLOCKED', -1)
        locals.set_int('MPX_CHAR_WEAP_UNLOCKED2', -1)
        locals.set_int('MPX_CHAR_WEAP_ADDON_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_WEAP_ADDON_2_UNLCK', -1)
        locals.set_int('MPX_CHAR_WEAP_ADDON_3_UNLCK', -1)
        locals.set_int('MPX_CHAR_WEAP_ADDON_4_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_UNLOCKED', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_UNLOCKED2', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_UNLOCKED3', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_UNLOCKED4', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_UNLOCKED5', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_2_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_3_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_4_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_5_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_6_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_7_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_8_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_9_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_10_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_11_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_12_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_13_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_14_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_15_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_16_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_17_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_18_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_19_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_WEAP_ADDON_20_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_HAIRCUT_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK1', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK2', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK3', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK4', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK5', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK6', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK7', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK8', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK9', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK10', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK11', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK12', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK13', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK14', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK15', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK16', -1)
        locals.set_int('MPX_CHAR_HAIR_UNLCK17', -1)
        locals.set_int('MPX_CHAR_FM_HEALTH_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_HEALTH_2_UNLCK', -1)
        locals.set_int('MPX_CRDEADLINE', 5)
        locals.set_int('MPX_CHAR_CREWUNLOCK_1_FM_EQUIP', -1)
        locals.set_int('MPX_CHAR_CREWUNLOCK_2_FM_EQUIP', -1)
        locals.set_int('MPX_CHAR_CREWUNLOCK_3_FM_EQUIP', -1)
        locals.set_int('MPX_CHAR_CREWUNLOCK_4_FM_EQUIP', -1)
        locals.set_int('MPX_CHAR_CREWUNLOCK_5_FM_EQUIP', -1)
        locals.set_int('MPX_CHAR_KIT_1_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_2_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_3_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_4_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_5_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_6_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_7_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_8_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_9_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_10_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_11_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_12_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_13_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_14_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_15_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_16_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_17_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_18_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_19_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_20_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_21_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_22_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_23_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_24_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_25_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_26_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_27_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_28_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_29_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_30_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_30_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_31_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_32_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_33_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_34_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_35_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_36_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_37_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_38_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_39_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_40_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_KIT_41_FM_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_ABILITY_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_ABILITY_2_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_ABILITY_3_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_2_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_3_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_4_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_5_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_6_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_7_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_8_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_9_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_10_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CLOTHES_11_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_VEHICLE_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_VEHICLE_2_UNLCK', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_0', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_1', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_2', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_3', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_4', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_5', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_6', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_7', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_8', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_9', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_10', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_11', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_12', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_13', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_14', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_15', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_16', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_17', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_18', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_19', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_20', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_21', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_22', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_23', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_24', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_25', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_26', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_27', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_28', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_29', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_30', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_31', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_32', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_33', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_34', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_35', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_36', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_37', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_38', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_39', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_40', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_41', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_42', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_43', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_44', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_45', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_46', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_47', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_48', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_49', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_50', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_51', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_52', -1)
        locals.set_int('MPX_TATTOO_FM_UNLOCKS_53', -1)
        locals.set_int('MPX_RANKAP_UNLK_0', -1)
        locals.set_int('MPX_RANKAP_UNLK_1', -1)
        locals.set_int('MPX_RANKAP_UNLK_2', -1)
        locals.set_int('MPX_RANKAP_UNLK_3', -1)
        locals.set_int('MPX_CHAR_CREWUNLOCK_1_UNLCK', -1)
        locals.set_int('MPX_SR_WEAPON_BIT_SET', -1)
        locals.set_int('MPX_CAR_CLUB_REP', 997430)
        ...
        locals.set_int('MPX_CHAR_HEIST_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_VEHICLE_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_VEHICLE_2_UNLCK', -1)
        locals.set_int('MPX_CRHEIST', 50)
        locals.set_int('MPX_CR_BANKHEIST1', 10)
        locals.set_int('MPX_CR_COUNTHEIST1', 10)
        locals.set_int('MPX_HEIST_COMPLETION', 26)
        locals.set_int('MPX_HEIST_TOTAL_TIME', 86400000)
        locals.set_int('MPX_HEISTS_ORGANISED', 50)
        locals.set_int('MPX_RACES_WON', 50)
        locals.set_int('MPX_CHAR_FM_PACKAGE_1_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_2_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_3_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_4_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_5_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_6_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_7_COLLECT', -1)
        locals.set_int('MPX_CHAR_FM_PACKAGE_8_COLLECT', -1)
        locals.set_int('MPX_CHAR_NO_FM_PACKAGES_COL', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_1_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_2_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_3_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_4_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_5_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_6_UNLCK', -1)
        locals.set_int('MPX_CHAR_FM_CARMOD_7_UNLCK', -1)
        locals.set_int('MPX_NUMBER_SLIPSTREAMS_IN_RACE', 110)
        locals.set_int('MPX_NUMBER_TURBO_STARTS_IN_RACE', 90)
        locals.set_int('MPX_USJS_FOUND', 50)
        locals.set_int('MPX_USJS_COMPLETED', 50)
        locals.set_int('MPX_MPPLY_TIMES_RACE_BEST_LAP', 101)
        locals.set_int('MPX_AWD_FMRALLYWONDRIVE', 25)
        locals.set_int('MPX_AWD_FMWINSEARACE', 25)
        locals.set_int('MPX_AWD_FMWINAIRRACE', 25)
        locals.set_int('MPX_AWD_FM_RACES_FASTEST_LAP', 101)
        locals.set_int('MPX_SCRIPT_INCREASE_STAM', 100)
        locals.set_int('MPX_SCRIPT_INCREASE_STRN', 100)
        locals.set_int('MPX_SCRIPT_INCREASE_FLY', 100)
        locals.set_int('MPX_SCRIPT_INCREASE_STL', 100)
        locals.set_int('MPX_SCRIPT_INCREASE_LUNG', 100)
        locals.set_int('MPX_SCRIPT_INCREASE_DRIV', 100)
        locals.set_int('MPX_SCRIPT_INCREASE_SHO', 100)
        locals.set_int('MPX_AWD_DANCE_TO_SOLOMUN', 360)
        locals.set_int('NIGHTCLUB_HOTSPOT_TIME_MS', 3600000)
        locals.set_int('MPX_CASINO_DECORATION_GIFT_1', -1);
        ...
        locals.set_int('MPX_AWD_SHARPSHOOTER', 40) -- Badlands Revenge II -- Sharpshooter
        locals.set_int('MPX_AWD_RACECHAMP', 40) -- Race and Chase -- Race Champion
        locals.set_int('MPX_AWD_BATSWORD', 1000000) -- The Wizard's Ruin -- Platinum Sword
        locals.set_int('MPX_AWD_COINPURSE', 950000) -- The Wizard's Ruin -- Platinum Sword -- Coin Purse
        locals.set_int('MPX_AWD_ASTROCHIMP', 3000000) -- Space Monkey 3: Bananas Gone Bad -- Astrochimp
        locals.set_int('MPX_AWD_MASTERFUL', 40000) -- Penetrator -- Masterful
        locals.set_int('MPX_SCGW_NUM_WINS_GANG_0', 55) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 1
        locals.set_int('MPX_SCGW_NUM_WINS_GANG_1', 56) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 2
        locals.set_int('MPX_SCGW_NUM_WINS_GANG_2', 57) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 3
        locals.set_int('MPX_SCGW_NUM_WINS_GANG_3', 58) -- Street Crimes: Gang Wars Edition -- Win 20 games with character 4
        locals.set_int('MPX_IAP_MAX_MOON_DIST', 2147483647) -- Invade and Persuade II -- Travel 3,474,000km on the moon
        locals.set_int('MPX_LAST_ANIMAL', 108) -- Invade and Persuade II -- Kill 100 animals in a single playthrough
        locals.set_int('MPX_CH_ARC_CAB_CLAW_TROPHY', -1) -- Kitty Claw Trophy
        locals.set_int('MPX_CH_ARC_CAB_LOVE_TROPHY', -1) -- The Love Professor Trophy
        locals.set_int('MPX_AWD_FACES_OF_DEATH', 50) -- Camhedz -- Faces Of Death
        locals.set_int('MPX_REV_NV_KILLS', 50) -- Navy Revolver Kills
        locals.set_int("MPX_XM22_FLOW", -1) -- Acid Lab Unlock
        locals.set_int("MPX_XM22_MISSIONS", -1) -- Acid Lab Unlock
        locals.set_int("MPX_PET_CHOP_TIME", NETWORK.GET_CLOUD_TIME_AS_INT() - 86400) -- Pet Chop Time?
        stats.set_bool("MPX_AWD_DOGS_BEST_FRIEND", true) -- Pet Chop Time?
        locals.set_int("MPX_AWD_CALLME", tunables.get_int(654710993)) -- Acid Lab Equipment Unlock
        locals.set_int("MPX_H3_VEHICLESUSED", -1) -- Trade Price for Diamond Casino Heist Finale.
        locals.set_int("MPX_H4_H4_DJ_MISSIONS", -1) -- Trade Price for MP0_H4_H4_DJ_MISSIONS
        locals.set_int("MPX_H4_PROGRESS", -1) -- Trade Price for winky
        locals.set_int("MPX_TUNER_GEN_BS", -1) -- Trade Price for tailgater2
        locals.set_int("MPX_FIXER_HQ_OWNED", 1) -- Trade Price for buffalo4
        locals.set_int("MPX_ULP_MISSION_PROGRESS", -1) -- Trade Price greenwood/conada
        locals.set_int("MPX_SUM23_AVOP_PROGRESS", -1) -- Trade Price Raiju
        locals.set_int("MPX_GANGOPS_FLOW_BITSET_MISS0", -1) -- Trade Price for deluxo/akula/riot2/stromberg/chernobog/barrage/khanjali/volatol/thruster
        ...
        locals.set_int("MPPLY_HEISTFLOWORDERPROGRESS", -1)
        locals.set_int("MPPLY_HEISTNODEATHPROGREITSET", -1)
        locals.set_int("MPPLY_HEISTTEAMPROGRESSBITSET", -1)
        locals.set_int("MPX_AT_FLOW_VEHICLE_BS", -1) -- Trade price for dune4/dune5/wastelander/blazer5/phantom2/voltic2/technical2/boxville5/ruiner2
        locals.set_int("MPX_LFETIME_HANGAR_BUY_COMPLET", 50) -- Trade price for microlight/rogue/alphaz1/havok/starling/molotok/tula/bombushka/howard/mogul/pyro/seabreeze/nokota/hunter
        locals.set_int("MPX_SALV23_GEN_BS", -1) -- police4 trade price
        locals.set_int("MPX_SALV23_INST_PROG", -1) -- polgauntlet trade price
        locals.set_int("MPX_SALV23_SCOPE_BS", -1) -- police5 trade price
        locals.set_int("MPX_MOST_TIME_ON_3_PLUS_STARS", 300000) -- police4 trade price
        locals.set_int("MPX_LOWRIDER_FLOW_COMPLETE", 1)
        locals.set_int("MPX_AT_FLOW_MISSION_PROGRESS", 50)
        locals.set_int("MPX_AT_FLOW_IMPEXP_NUM", 50)
        locals.set_int("MPX_AT_FLOW_BITSET_MISSIONS0", -1)
        locals.set_int("MPX_WVM_FLOW_MISSION_PROGRESS", 50)
        locals.set_int("MPX_WVM_FLOW_IMPEXP_NUM", 50)
        locals.set_int("MPX_WVM_FLOW_BITSET_MISSIONS0", -1)
        locals.set_int("MPX_WVM_FLOW_VEHICLE_BS", -1)
        locals.set_int("MPX_GANGOPS_FLOW_MISSION_PROG", -1)
        locals.set_int("MPX_GANGOPS_FLOW_IMPEXP_NUM", 50)
        locals.set_int("MPX_WAM_FLOW_VEHICLE_BS", -1)
        locals.set_int("MPX_GANGOPS_FLOW_PASSED_BITSET", -1)
        locals.set_int("MPX_VCM_FLOW_PROGRESS", -1)
        locals.set_int("MPX_TUNER_FLOW_BS", -1)
        locals.set_int("MPX_TUNER_MIS_BS", -1)
        locals.set_int("MPX_TUNER_COMP_BS", -1)
        locals.set_int("MPX_GANGOPS_FM_MISSION_PROG", -1)
        locals.set_int("MPX_GANGOPS_FM_BITSET_MISS0", -1)
        ...
        locals.set_int("MPX_HEIST_SAVED_STRAND_0", tunables.get_int('ROOT_ID_HASH_THE_FLECCA_JOB'))
        locals.set_int("MPX_HEIST_SAVED_STRAND_0_L", 5)
        locals.set_int("MPX_HEIST_SAVED_STRAND_1", tunables.get_int('ROOT_ID_HASH_THE_PRISON_BREAK'))
        locals.set_int("MPX_HEIST_SAVED_STRAND_1_L", 5)
        locals.set_int("MPX_HEIST_SAVED_STRAND_2", tunables.get_int('ROOT_ID_HASH_THE_HUMANE_LABS_RAID'))
        locals.set_int("MPX_HEIST_SAVED_STRAND_2_L", 5)
        locals.set_int("MPX_HEIST_SAVED_STRAND_3", tunables.get_int('ROOT_ID_HASH_SERIES_A_FUNDING'))
        locals.set_int("MPX_HEIST_SAVED_STRAND_3_L", 5)
        locals.set_int("MPX_HEIST_SAVED_STRAND_4", tunables.get_int('ROOT_ID_HASH_THE_PACIFIC_STANDARD_JOB'))
        locals.set_int("MPX_HEIST_SAVED_STRAND_4_L", 5)
        locals.set_int("MPX_LIFETIME_BUY_COMPLETE", 1025)
        locals.set_int("MPX_LIFETIME_BUY_UNDERTAKEN", 1025)
        locals.set_int("MPX_LIFETIME_SELL_COMPLETE", 1025)
        locals.set_int("MPX_LIFETIME_SELL_UNDERTAKEN", 1025)
        locals.set_int("MPX_LIFETIME_CONTRA_EARNINGS", 25000000) --Contraband Earnings
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_UNDERTA", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_UNDERTA", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET1", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_UNDERTA1", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET1", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_UNDERTA1", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET2", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_UNDERTA2", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET2", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_UNDERTA2", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET3", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_UNDERTA3", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET3", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_UNDERTA3", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET4", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_UNDERTA4", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET4", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_UNDERTA4", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET5", 1025)
        locals.set_int("MPX_LFETIME_BIKER_BUY_UNDERTA5", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET5", 1025)
        locals.set_int("MPX_LFETIME_BIKER_SELL_UNDERTA5", 1025)
        locals.set_int("MPX_LIFETIME_BKR_SELL_EARNINGS0", 25000000)
        locals.set_int("MPX_LIFETIME_BKR_SELL_EARNINGS1", 25000000)
        locals.set_int("MPX_LIFETIME_BKR_SELL_EARNINGS2", 25000000)
        locals.set_int("MPX_LIFETIME_BKR_SELL_EARNINGS3", 25000000)
        locals.set_int("MPX_LIFETIME_BKR_SELL_EARNINGS4", 25000000)
        locals.set_int("MPX_LFETIME_BIKER_BUY_COMPLET6", 10) --Allow buying of Stank Breath acid name.
        locals.set_int("MPX_LFETIME_BIKER_SELL_COMPLET6", 10) --Allow buying of Squatch Bait acid  name.
        stats.set_packed_stat_int(41241, 5) --Allow buying of Chair Shot acid name.
        locals.set_int("MPX_LIFETIME_BKR_SELL_EARNINGS6", 1000000) --Allow buying of Fck Your Sleep acid name.
        ...
        locals.set_int("MPX_XMAS2023_ADV_MODE_WINS", 6) --Unlock Christmas 2023 liveries.
        locals.set_int("MPX_FIXER_GENERAL_BS", -8577) -- Trade price for champion/baller7
        locals.set_int("MPX_FIXER_COMPLETED_BS", -1) -- Compelete all The Contract missions.
        locals.set_int("MPX_FIXER_COUNT", 20) -- Trade price for granger2/deity/patriot3/jubilee
        locals.set_int("MPPLY_XMAS23_PLATES0", 3) -- ECola & Sprunk Plates
        locals.set_int("MPX_COUNT_HOTRING_RACE", 20) -- Liveries for hotring
        locals.set_int("MPX_FINISHED_SASS_RACE_TOP_3", 20) -- Trade price for hotring/everon2

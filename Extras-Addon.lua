...
Stats:add_button("Randomize RP", function()
    script.run_in_fiber(function (script)
        ...
        stats.set_int("MPX_CHAR_SET_RP_GIFT_ADMIN", randomizeRP)
...
Stats:add_button("Lvl 1", function()
    script.run_in_fiber(function (script)
        ...
        stats.set_int("MPX_CHAR_SET_RP_GIFT_ADMIN", rpLevel)
...
Stats:add_button("Reset Income/Spent Stats", function()
    script.run_in_fiber(function (script)
        stats.set_int("MPPLY_TOTAL_EVC", 0)
        stats.set_int("MPPLY_TOTAL_SVC", 0)
        stats.set_int("MPX_MONEY_EARN_BETTING", 0)
        stats.set_int("MPX_MONEY_EARN_JOBS", 0)
        stats.set_int("MPX_MONEY_EARN_SHARED", 0)
        stats.set_int("MPX_MONEY_SPENT_SHARED", 0)
        stats.set_int("MPX_MONEY_EARN_JOBSHARED", 0)
        stats.set_int("MPX_MONEY_EARN_SELLING_VEH", 0)
        stats.set_int("MPX_MONEY_SPENT_WEAPON_ARMOR", 0)
        stats.set_int("MPX_MONEY_SPENT_VEH_MAINTENANCE", 0)
        stats.set_int("MPX_MONEY_SPENT_STYLE_ENT", 0)
        stats.set_int("MPX_MONEY_SPENT_PROPERTY_UTIL", 0)
        stats.set_int("MPX_MONEY_SPENT_JOB_ACTIVITY", 0)
        stats.set_int("MPX_MONEY_SPENT_BETTING", 0)
        stats.set_int("MPX_MONEY_EARN_VEHICLE_EXPORT", 0)
        stats.set_int("MPX_MONEY_SPENT_VEHICLE_EXPORT", 0)
        stats.set_int("MPX_MONEY_EARN_CLUB_DANCING", 0)
        stats.set_int("MPX_CASINO_CHIPS_WON_GD", 0)
        stats.set_int("MPX_CASINO_CHIPS_WONTIM", 0)
        stats.set_int("MPX_CASINO_GMBLNG_GD", 0)
        stats.set_int("MPX_CASINO_BAN_TIME", 0)
        stats.set_int("MPX_CASINO_CHIPS_PURTIM", 0)
        stats.set_int("MPX_CASINO_CHIPS_PUR_GD", 0)
        if PI == 0 then
...
Stats:add_button("Max All Skills", function()
    script.run_in_fiber(function (script)
        stats.set_int("MPX_SCRIPT_INCREASE_DRIV", 1000)
        stats.set_int("MPX_SCRIPT_INCREASE_FLY", 1000)
        stats.set_int("MPX_SCRIPT_INCREASE_LUNG", 1000)
        stats.set_int("MPX_SCRIPT_INCREASE_SHO", 1000)
        stats.set_int("MPX_SCRIPT_INCREASE_STAM", 1000)
        stats.set_int("MPX_SCRIPT_INCREASE_STL", 1000)
        stats.set_int("MPX_SCRIPT_INCREASE_STRN", 1000)
...
StoryCharacters = KAOS:add_tab("Story Mode")
    ...
    StoryCharacters:add_imgui(function()
        ...
        if used then
            stats.set_int("SP0_TOTAL_CASH", mCash)
    ...
    StoryCharacters:add_imgui(function()
        ...
        if used then
            stats.set_int("SP1_TOTAL_CASH", fCash)
            if showNotifications:is_enabled() then gui.show_message('Story Mode Cash Updated!', out) end
        end
    end)
    ...
    StoryCharacters:add_imgui(function()
        ...
        if used then
            stats.set_int("SP2_TOTAL_CASH", tCash)
            if showNotifications:is_enabled() then gui.show_message('Story Mode Cash Updated!', out) end
        end
    end)
    ...
    StoryCharacters:add_imgui(function()
        ...
        if used then
            stats.set_int("SP0_SPECIAL_ABILITY", mStats)
            stats.set_int("SP0_STAMINA", mStats)
            stats.set_int("SP0_STRENGTH", mStats)
            stats.set_int("SP0_LUNG_CAPACITY", mStats)
            stats.set_int("SP0_WHEELIE_ABILITY", mStats)
            stats.set_int("SP0_FLYING_ABILITY", mStats)
            stats.set_int("SP0_SHOOTING_ABILITY", mStats)
            stats.set_int("SP0_STEALTH_ABILITY", mStats)
    ...
    StoryCharacters:add_imgui(function()
        ...
        if used then
            stats.set_int("SP1_SPECIAL_ABILITY", fStats)
            stats.set_int("SP1_STAMINA", fStats)
            stats.set_int("SP1_STRENGTH", fStats)
            stats.set_int("SP1_LUNG_CAPACITY", fStats)
            stats.set_int("SP1_WHEELIE_ABILITY", fStats)
            stats.set_int("SP1_FLYING_ABILITY", fStats)
            stats.set_int("SP1_SHOOTING_ABILITY", fStats)
            stats.set_int("SP1_STEALTH_ABILITY", fStats)
            if showNotifications:is_enabled() then gui.show_message('Story Mode Stats Updated!', out) end
        end
    end)
    ...
    StoryCharacters:add_imgui(function()
        ...
        if used then
            stats.set_int("SP2_SPECIAL_ABILITY", tStats)
            stats.set_int("SP2_STAMINA", tStats)
            stats.set_int("SP2_STRENGTH", tStats)
            stats.set_int("SP2_LUNG_CAPACITY", tStats)
            stats.set_int("SP2_WHEELIE_ABILITY", tStats)
            stats.set_int("SP2_FLYING_ABILITY", tStats)
            stats.set_int("SP2_SHOOTING_ABILITY", tStats)
            stats.set_int("SP2_STEALTH_ABILITY", tStats)
            if showNotifications:is_enabled() then gui.show_message('Story Mode Stats Updated!', out) end
        end
    end)
	...
	if ImGui.BeginTabBar("##MainTabBar") then
		...
		textSeparator("", "Agency Controls")
			...
			contractChanged = false
				...
				if ImGui.Button("Select Contract") then
					...
					if contractToUse and contractToUse.id then  -- Ensure contractToUse is not nil and has a valid id
						stats.set_int("MPX_FIXER_STORY_BS", contractToUse.id)
			...
			if ImGui.Button("Complete Preps") then
				script.run_in_fiber(function(script)
					...
					stats.set_int("MPX_FIXER_COMPLETED_BS", -1)
					stats.set_int("MPX_FIXER_STORY_COOLDOWN_POSIX", -1)
					script:yield()
				end)
			end
			...
			if ImGui.Button("Skip Cooldown") then
				script.run_in_fiber(function(script)
					...
					stats.set_int("MPX_FIXER_STORY_COOLDOWN", -1)
					script:yield()
				end)
			end
		...
		textSeparator("", "Bunker Controls")
			if ImGui.Button("Unlock Shooting Range") then 
				script.run_in_fiber(function(script)
					stats.set_int("MPX_SR_HIGHSCORE_1", 690)
					stats.set_int("MPX_SR_HIGHSCORE_2", 1860)
					stats.set_int("MPX_SR_HIGHSCORE_3", 2690)
					stats.set_int("MPX_SR_HIGHSCORE_4", 2660)
					stats.set_int("MPX_SR_HIGHSCORE_5", 2650)
					stats.set_int("MPX_SR_HIGHSCORE_6", 450)
					stats.set_int("MPX_SR_TARGETS_HIT", 269)
		...
		if ImGui.BeginTabItem("Hangar") then
			...
			ImGui.SameLine()
			if ImGui.Button("Skip Cooldown") then 
				stats.set_int("SMUG_SELL_SELL_COOLDOWN_TIMER", 0)
			end
...
script.register_looped("agencySafeloop", function(script)
	...
	if agencySafeLoop then
		...
		stats.set_int("MPX_FIXER_COUNT", 500)
		stats.set_int("MPX_FIXER_PASSIVE_PAY_TIME_LEFT", -1)
		sleep(0.5)
	end
end)
...
casinoHeist:add_button("Silent & Sneaky", function()
    ...
    stats.set_int("MPX_H3OPT_TARGET", 3)
...
casinoHeist:add_button("Big Con", function()
    ...
    stats.set_int("MPX_H3OPT_VEHS", 3)
    stats.set_int("MPX_H3OPT_WEAPS", 1)
    stats.set_int("MPX_H3OPT_BITSET0", 524118)
    stats.set_int("MPX_H3OPT_MASKS", 9)
	stats.set_int("MPX_H3_COMPLETEDPOSIX", -1)
	stats.set_int("MPX_CAS_HEIST_FLOW", -1)
	stats.set_int("MPX_H3_HARD_APPROACH", 0)
...
casinoHeist:add_button("Aggressive", function()
    ...
    stats.set_int("MPX_H3OPT_VEHS", 3)
    stats.set_int("MPX_H3OPT_WEAPS", 1)
    stats.set_int("MPX_H3OPT_BITSET0", 3670102)
    stats.set_int("MPX_H3OPT_MASKS", 9)
	stats.set_int("MPX_H3_COMPLETEDPOSIX", -1)
	stats.set_int("MPX_CAS_HEIST_FLOW", -1)
	stats.set_int("MPX_H3_HARD_APPROACH", 0)
	...
	if ImGui.TreeNode("Compound Loot") then
		...
		if compoundCash then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_CASH_C", sliderValue)
				stats.set_int("MPX_H4LOOT_CASH_C_SCOPED", sliderValue)
			end
		else
		...
		if compoundWeed then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_WEED_C", sliderValue)
				stats.set_int("MPX_H4LOOT_WEED_C_SCOPED", sliderValue)
			end
		else
		...
		if compoundCoke then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_COKE_C", sliderValue)
				stats.set_int("MPX_H4LOOT_COKE_C_SCOPED", sliderValue)
			end
		else
		...
		if compoundGold then
			...
			if changed2 then
				...
				stats.set_int("MPX_H4LOOT_GOLD_C", sliderValue)
				stats.set_int("MPX_H4LOOT_GOLD_C_SCOPED", sliderValue)
			end
		else
		...
		if compoundPaintings then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_PAINT", sliderValue)
				stats.set_int("MPX_H4LOOT_PAINT_SCOPED", sliderValue)
			end
		else
	...
	if ImGui.TreeNode("Island Loot") then
		...
		if islandCash then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_CASH_I", sliderValue)
				stats.set_int("MPX_H4LOOT_CASH_I_SCOPED", sliderValue)
			end
		else
		...
		if islandWeed then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_WEED_I", sliderValue)
				stats.set_int("MPX_H4LOOT_WEED_I_SCOPED", sliderValue)
			end
		else
		...
		if islandCoke then
			...
			if changed then
				...
				stats.set_int("MPX_H4LOOT_COKE_I", sliderValue)
				stats.set_int("MPX_H4LOOT_COKE_I_SCOPED", sliderValue)
			end
		else
		...
		if islandGold then
			...
			if changed2 then
				...
				stats.set_int("MPX_H4LOOT_GOLD_I", sliderValue)
				stats.set_int("MPX_H4LOOT_GOLD_I_SCOPED", sliderValue)
			end
		else
			stats.set_int("MPX_H4LOOT_GOLD_I", 0)
			stats.set_int("MPX_H4LOOT_GOLD_I_SCOPED", 0)
		end
	ImGui.TreePop()
	end
	ImGui.EndGroup()
	...
	ImGui.BeginGroup()
            ...
            if ImGui.BeginListBox("##weaponList", 140, 145) then
                for k, v in pairs(weapons) do
                    ...
                    if ImGui.Selectable(v, selected) and not selected then
                            stats.set_int("MPX_H4CNF_WEAPONS", k)
                    end
...
toolTip(cayoHeist, "Skips all the minigame hacks, simply press to skip")
cayoHeist:add_sameline()
...
goldSizeVal, used = ImGui.SliderInt("Gold Value", goldSizeVal, 45375, 181500) -- Quadruple the original price
    ...
    if used then
        ...
        stats.set_int("MPX_H4LOOT_GOLD_V", goldSizeVal)
...
cokeSizeVal, used = ImGui.SliderInt("Coke Value", cokeSizeVal, 25312, 101248) -- Quadruple the original price
    ...
    if used then
        ...
        stats.set_int("MPX_H4LOOT_COKE_V", cokeSizeVal)
...
paintSizeVal, used = ImGui.SliderInt("Paintings Value", paintSizeVal, 22500, 90000) -- Quadruple the original price
    ...
    if used then
        ...
        stats.set_int("MPX_H4LOOT_PAINT_V", paintSizeVal)
...
weedSizeVal, used = ImGui.SliderInt("Weed Value", weedSizeVal, 16875, 67500) -- Quadruple the original price
    ...
    if used then
        ...
        stats.set_int("MPX_H4LOOT_WEED_V", weedSizeVal)
...
cashSizeVal, used = ImGui.SliderInt("Cash Value", cashSizeVal, 10406, 41624) -- Quadruple the original price
    ...
    if used then
        ...
        stats.set_int("MPX_H4LOOT_WEED_V", cashSizeVal)
...
DP:add_sameline()
DP:add_button("Complete Preps", function() stats.set_int("MPX_GANGOPS_FM_MISSION_PROG", -1) end)
DP:add_sameline()
...
cluckinHeist:add_imgui(function()
    ...
    if ImGui.Button("Set Mission") then
        if salvageMissionID == 1 then
            stats.set_int("MPX_SALV23_INST_PROG", 0) -- Slush Fund
        elseif salvageMissionID == 2 then
            stats.set_int("MPX_SALV23_INST_PROG", 1) -- Breaking and Entering
        elseif salvageMissionID == 3 then
            stats.set_int("MPX_SALV23_INST_PROG", 3) -- Concealed Weapons
        elseif salvageMissionID == 4 then
            stats.set_int("MPX_SALV23_INST_PROG", 7) -- Hit and Run
        elseif salvageMissionID == 5 then
            stats.set_int("MPX_SALV23_INST_PROG", 15) -- Disorganized Crime
        elseif salvageMissionID == 6 then
            stats.set_int("MPX_SALV23_INST_PROG", 31) -- Scene of The Crime
        end
        stats.set_int("MPX_SALV23_CFR_COOLDOWN", -1) -- Removes the cooldown
    end
end)
...
griefPlayerTab:add_imgui(function()
    ...
    local selfID = PLAYER.GET_PLAYER_NAME(PLAYER.PLAYER_ID())

...
casinoHeist:add_button("Setup The Big Con", function()
...
casinoHeist:add_sameline()
casinoHeist:add_button("Setup Aggressive", function()
...
casinoHeist:add_sameline()
casinoHeist:add_button("Instant Finish", function()
	locals.set_int(FMC2020, 50150, 9)
	locals.set_int(FMC2020, 50150 + 1770 + 1, 50)
	gui.show_message("Casino Heist", "Instantly Finished the heist.  Enjoy!")
end)
toolTip(casinoHeist, "Instantly completes the heist")
casinoHeist:add_sameline()

...
-- globals.set_int(1662873 + 1, 1) -- placeholder
-- Still need the proper globals/packed stats for this to work :(
-- Supposed to restock all nightclub warehouse goods in 1 click.
gui.show_message("Nightclub", "Currently not working")
end)

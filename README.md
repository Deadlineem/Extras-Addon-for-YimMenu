...
1. To install the extras addon, simply download the [![Button](https://img.shields.io/badge/Update-Batch-blue)](https://github.com/Deadlineem/Extras_Addon/blob/main/update.bat) you do not need to download the entire zip folder!
...
If you do not have the latest version, you can get it Here -> [![Button](https://img.shields.io/badge/Update-Batch-blue)](https://github.com/Deadlineem/Extras_Addon/blob/main/update.bat)
